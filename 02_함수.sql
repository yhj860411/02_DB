...
SELECT SYSDATE FROM DUAL; -- 2025-10-20 09:14:54.000

-- SYSTIMESTAMP : SYSDATE + MS 단위 추가(UTC 정보)
SELECT SYSTIMESTAMP FROM DUAL; -- 2025-10-20 09:16:10.723 +0900
...
SELECT ADD_MONTHS(SYSDATE, 4) FROM DUAL; -- 2026-02-20 09:31:16.000
SELECT ADD_MONTHS(SYSDATE, -1) FROM DUAL; -- 2025-09-20 09:31:01.000
...
-- R 패턴 : 1세기 기준으로 절반(50년) 이상은 경우는 이전세기(1900년대)
...
SELECT TO_DATE('700505', 'RRMMDD') FROM DUAL; -- 1970-05-05 00:00:00.000
