-- DDL(Date Definition Languange) : 데이터 정의 언어
...
-- *** DEPT_COPY의 DEPT_TITLE 컬럼에 NOT NUL 제약조건 추가/삭제 ***
ALTER TABLE DEPT_COPY 
...
SELECT * FROM TB2; -- TB2 테이블은 독립직인 테이블로 혼자 남게됨(아무 관계 없음)
----------------------------------------------------------------
-- DDL 주의 사항
...
ROLLBACK;
SELECT * FROM TB2;
-- 롤백 안된다. 위에서 DDL 구문 중 ALTER 를 사용하여 그 시점에 COMMIT 됨